...
//        mDivider = a.getDrawable(0)
     ...
     */
    constructor(context: Context, orientation: Int, dividerHeight: Int, dividerColor: Int = Color.GRAY) : this(
        context,
        orientation
    ) {
...
//            HORIZONTAL -> outRect.set(0, 0, mDividerHeight, 0)
//            else -> outRect.set(0, 0, mDividerHeight, mDividerHeight)
            else -> outRect.set(0, 0, mDividerHeight, 0)
        }
    }
